...
<template>
  <section
    class="pt-36 pb-24 bg-light dark:bg-dark transition-colors dark:text-white"
    id="about"
  >
          ...
          <div class="flex mx-auto">
            <div class="grid grid-cols-3 gap-4 md:grid-cols-8 lg:grid-cols-5">
              ...
              <a
                ...
                >
                  <NuxtImg
                    src="https://drive.alkademi.id/v1/upload/program/1693564681828.png"
                    alt="Nuxt Logo"
                    class="h-16 w-16"
                  /></div
              ></a>
